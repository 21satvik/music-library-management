...
def view(): 
    ...
    btn1 = Button(root,text="All Songs",font='Helvetica 10 bold',bg='black', fg='black', command=viewallsongs)
    btn1.place(relx=0.28,rely=0.42, relwidth=0.45,relheight=0.1)

    btn2 = Button(root,text="View Playlists",font='Helvetica 10 bold',bg='black', fg='black', command=viewplaylists)
