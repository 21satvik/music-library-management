...
btn1 = Button(root,text="Add Track",font='Helvetica 10 bold',bg='black', fg='black', command=addsong)
btn1.place(relx=0.28,rely=0.4, relwidth=0.45,relheight=0.1)

btn2 = Button(root,text="Delete Track",font='Helvetica 10 bold',bg='black', fg='black', command=delete)
btn2.place(relx=0.28,rely=0.5, relwidth=0.45,relheight=0.1)

btn3 = Button(root,text="View Tracks",font='Helvetica 10 bold',bg='black', fg='black', command=view)
