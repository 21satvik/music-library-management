...
def delete():
    ...
    background_image = Image.open("images/delete.jpg")
    ...
    SubmitBtn = Button(root,text="Submit",font='Helvetica 11 bold',bg="#010103", fg='black',command=deletesong)
    SubmitBtn.place(relx=0.28,rely=0.75, relwidth=0.18,relheight=0.08)

    quitBtn = Button(root,text="Quit",font='Helvetica 11 bold',bg="#010103", fg='black', command=root.destroy)
